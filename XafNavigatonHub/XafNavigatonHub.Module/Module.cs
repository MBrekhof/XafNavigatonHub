...
namespace XafNavigatonHub.Module
{
    ...
    public sealed class XafNavigatonHubModule : ModuleBase
    {
        public XafNavigatonHubModule()
        {
            //
            // XafNavigatonHubModule
            //
            AdditionalExportedTypes.Add(typeof(XafNavigatonHub.Module.BusinessObjects.ApplicationUser));
